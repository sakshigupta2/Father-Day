        ...
        <View style={{flex:1}}>
          <MyHeader title="Premium Quotation" navigation ={this.props.navigation}/>
            <KeyboardAvoidingView style={styles.keyBoardStyle}>
              ...
              <TouchableOpacity
                style={styles.button}
                onPress={()=>{this.addRequest(this.state.fullName,this.state.vehicleNumber, this.state.modelYear, this.state.phoneNumber, this.state.vehicleModel, this.state.lastYearClaim,)}}
                >
